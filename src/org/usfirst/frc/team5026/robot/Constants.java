...
public class Constants {
	...
	public static final double DRIVE_JOYSTICK_X_SCALING = 0.4; //Need to fix at comp.
	public static final double DRIVE_JOYSTICK_Y_SCALING = 0.35; //Need to fix at comp.
